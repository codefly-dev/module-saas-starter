...
function SheetTitle({ className, ...props }: SheetPrimitive.Title.Props) {
	return (
		<SheetPrimitive.Title
			...
			className={cn(
				"type-sheet-title text-foreground",
				className,
			)}
			{...props}
		/>
...
function SheetDescription({
	...
	return (
		<SheetPrimitive.Description
			...
			className={cn("type-sheet-description text-muted-foreground", className)}
			{...props}
		/>
	);
}
