...
export const PERMISSION_DEFINITIONS: Readonly<Record<Permission, PermissionDefinition>> = {
  ...
  [PERMISSIONS.DATASOURCES_READ]: { resource: "datasources", action: "read", description: "List and get datasource sources.", builtInRoles: ["admin (via *:*)"], apiKeyScope: true },
  [PERMISSIONS.DATASOURCES_WRITE]: { resource: "datasources", action: "write", description: "Create, delete, and sync datasource sources.", builtInRoles: ["admin (via *:*)"], apiKeyScope: true },
