...
export const FRONTEND_ROUTES = [
  ...
  { path: "/admin/permissions", sourcePath: "src/app/admin/permissions/page.tsx", match: "exact", access: "admin" },
  ...
  { path: "/admin/roles/{roleId}", sourcePath: "src/app/admin/roles/[roleId]/page.tsx", match: "parameter", access: "admin" },
  ...
  { path: "/admin/teams", sourcePath: "src/app/admin/teams/page.tsx", match: "exact", access: "authenticated" },
  { path: "/admin/teams/{teamId}", sourcePath: "src/app/admin/teams/[teamId]/page.tsx", match: "parameter", access: "authenticated" },
  { path: "/admin/users", sourcePath: "src/app/admin/users/page.tsx", match: "exact", access: "admin" },
  { path: "/admin/users/{userId}", sourcePath: "src/app/admin/users/[userId]/page.tsx", match: "parameter", access: "admin" },
...
export const FRONTEND_NAVIGATION: readonly FrontendNavigationItem[] = [
  ...
  { id: "admin-teams", plugin: "core-users", label: "Teams", href: "/admin/teams", icon: "UsersRound", group: "Users & Access", access: "authenticated", requiredPermission: "teams:read", surfaces: ["command_palette", "plugin_registry", "sidebar"], order: 120 },
  ...
  { id: "admin-permissions", plugin: "core-users", label: "Permissions", href: "/admin/permissions", icon: "KeyRound", group: "Users & Access", access: "admin", requiredRole: "admin", requiredPermission: "roles:read", surfaces: ["command_palette", "plugin_registry", "sidebar"], order: 135 },
