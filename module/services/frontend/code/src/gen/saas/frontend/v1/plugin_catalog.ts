...
export const FRONTEND_ROUTES = [
  ...
  { path: "/admin/audit-export", sourcePath: "src/app/admin/audit-export/page.tsx", match: "exact", access: "admin" },
...
export const FRONTEND_NAVIGATION: readonly FrontendNavigationItem[] = [
  ...
  { id: "admin-audit-export", plugin: "audit", label: "Audit Export", href: "/admin/audit-export", icon: "HardDriveDownload", group: "Integrations", access: "admin", requiredRole: "admin", requiredPermission: "audit:read", surfaces: ["sidebar"], order: 410 },
  ...
  { id: "settings", plugin: "core-users", label: "Settings", href: "/settings", icon: "Settings", group: "Settings", access: "authenticated", surfaces: ["command_palette", "plugin_registry", "sidebar", "user_menu"], order: 590 },
