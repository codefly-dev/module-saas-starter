...
export function mockAuditEvent(
...
export function mockPlatformAdmin(
	overrides: Partial<MockPlatformAdmin> = {},
): MockPlatformAdmin {
	return {
		userId: nextId(),
...
export function mockFeatureFlag(
	overrides: Partial<MockFeatureFlag> = {},
): MockFeatureFlag {
	return {
