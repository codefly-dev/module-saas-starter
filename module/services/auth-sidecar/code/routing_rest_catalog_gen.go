...
func generatedCatalogRESTRoutes() []*RouteEntry {
	return []*RouteEntry{
		...
		{Service: "accounts", Method: "GET", Path: "/v1/devices", Procedure: "/saas.accounts.v1.DeviceService/ListDevices"},
		...
		{Service: "accounts", Method: "POST", Path: "/v1/devices/claim", Procedure: "/saas.accounts.v1.DeviceService/ClaimDevice"},
		{Service: "accounts", Method: "POST", Path: "/v1/devices/claim-codes", Procedure: "/saas.accounts.v1.DeviceService/CreateClaimCode"},
		{Service: "accounts", Method: "POST", Path: "/v1/devices/entitlements/check", Procedure: "/saas.accounts.v1.EntitlementCheckService/CheckDeviceEntitlement"},
		{Service: "accounts", Method: "POST", Path: "/v1/devices/{device_id}:revoke", Procedure: "/saas.accounts.v1.DeviceService/RevokeDevice"},
