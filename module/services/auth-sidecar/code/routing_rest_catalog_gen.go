...
func generatedCatalogRESTRoutes() []*RouteEntry {
	return []*RouteEntry{
		...
		{Service: "accounts", Method: "GET", Path: "/v1/datasources", Procedure: "/saas.accounts.v1.DatasourceService/ListSources"},
		...
		{Service: "accounts", Method: "POST", Path: "/v1/datasources/github", Procedure: "/saas.accounts.v1.DatasourceService/AddGitHubSource"},
		{Service: "accounts", Method: "POST", Path: "/v1/datasources/{id}:sync", Procedure: "/saas.accounts.v1.DatasourceService/Sync"},
