...
func generatedCatalogRESTRoutes() []*RouteEntry {
	return []*RouteEntry{
		...
		{Service: "accounts", Method: "GET", Path: "/v1/onboarding", Procedure: "/saas.accounts.v1.OnboardingService/GetProgress"},
		...
		{Service: "accounts", Method: "POST", Path: "/v1/consent/accept", Procedure: "/saas.accounts.v1.ConsentService/Accept"},
		...
		{Service: "accounts", Method: "POST", Path: "/v1/onboarding/{step_name}:complete", Procedure: "/saas.accounts.v1.OnboardingService/CompleteStep"},
		{Service: "accounts", Method: "POST", Path: "/v1/onboarding/{step_name}:skip", Procedure: "/saas.accounts.v1.OnboardingService/SkipStep"},
