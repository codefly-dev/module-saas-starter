...
func generatedCatalogRESTRoutes() []*RouteEntry {
	return []*RouteEntry{
		...
		{Service: "accounts", Method: "POST", Path: "/v1/auth/clients/authorize", Procedure: "/saas.accounts.v1.AuthService/IssueClientAuthorizationCode"},
		{Service: "accounts", Method: "POST", Path: "/v1/auth/clients/validate", Procedure: "/saas.accounts.v1.AuthService/ValidateClientAuthorization"},
		...
		{Service: "accounts", Method: "POST", Path: "/v1/auth/token", Procedure: "/saas.accounts.v1.AuthService/ExchangeClientToken"},
