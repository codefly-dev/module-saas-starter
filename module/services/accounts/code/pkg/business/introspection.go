...
var rpcDescriptions = withWorkContextConsumerDescriptions(map[string]string{
	...
	"DatasourceService/CreateSource":           "Create an org-owned connection to an external system.",
	"DatasourceService/DeleteSource":           "Delete a datasource source.",
	"DatasourceService/GetSource":              "Get one datasource source in the caller's org.",
	"DatasourceService/ListSources":            "List the org's datasource sources.",
	"DatasourceService/SyncSource":             "Request a sync for a datasource source.",
