...
var rpcDescriptions = withWorkContextConsumerDescriptions(map[string]string{
	...
	"DatasourceService/AddGitHubSource":        "Add a GitHub source and store its access credential as an encrypted secret reference.",
	"DatasourceService/ListSources":            "List the org's datasource source connections.",
	"DatasourceService/Sync":                   "Mark a datasource source for ingestion.",
