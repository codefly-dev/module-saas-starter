...
var servicePermissionVocabulary = []servicePermissionDefinition{
	...
	{Permission: "datasources:read", Description: "List and get datasource sources.", BuiltInRoles: []string{"admin (via *:*)"}, APIKeyScope: true},
	{Permission: "datasources:write", Description: "Create, delete, and sync datasource sources.", BuiltInRoles: []string{"admin (via *:*)"}, APIKeyScope: true},
