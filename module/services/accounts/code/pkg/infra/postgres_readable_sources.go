...
// holds no domain content and so cannot name the resource itself. An empty set
// matches no grant and no share, so a module that declared none reads nothing
// rather than reading under invented authority (fail-closed).
