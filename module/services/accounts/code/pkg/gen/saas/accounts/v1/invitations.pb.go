...
const file_saas_accounts_v1_invitations_proto_rawDesc = "" +
	...
	"%INVITATION_DELIVERY_STATUS_COMPLAINED\x10\x062\x94\v\n" +
	"\x11InvitationService\x12\xe8\x01\n" +
	"\x10CreateInvitation\x12).saas.accounts.v1.CreateInvitationRequest\x1a*.saas.accounts.v1.CreateInvitationResponse\"}\xc2\xf3\x18_\b\x02\x10\x04\x1a\x11invitations:write\"\x11invitations:write*\f\n" +
	"\x06org_id\x10\x02\x18\x010\x01:\x19\n" +
	"\x15invitation.created.v1\x10\x02@\x01H\x04P\x03X\x03`\x01\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/v1/invitations\x12\xa0\x01\n" +
	...
	"\x15InspectInvitationById\x12..saas.accounts.v1.InspectInvitationByIdRequest\x1a#.saas.accounts.v1.InvitationSummary\"=\xc2\xf3\x18\x14\b\x02\x10\x020\x01:\x02\x10\x01@\x01H\x03P\x03X\x03`\x01\x82\xd3\xe4\x93\x02\x1f:\x01*\"\x1a/v1/invitations:inspect-id\x12\xbc\x01\n" +
	"\x10AcceptInvitation\x12).saas.accounts.v1.AcceptInvitationRequest\x1a*.saas.accounts.v1.AcceptInvitationResponse\"Q\xc2\xf3\x18,\b\x02\x10\x020\x01:\x1a\n" +
	"\x16invitation.accepted.v1\x10\x02@\x01H\x04P\x04X\x03`\x01\x82\xd3\xe4\x93\x02\x1b:\x01*\"\x16/v1/invitations:accept\x12\xc9\x01\n" +
	...
	"\x06org_id\x10\x02\x18\x010\x01:\x02\x10\x01@\x01H\x03P\x03X\x03`\x01\x82\xd3\xe4\x93\x02\x11\x12\x0f/v1/invitations\x12\xe2\x01\n" +
	"\x10ResendInvitation\x12).saas.accounts.v1.ResendInvitationRequest\x1a\x1c.saas.accounts.v1.Invitation\"\x84\x01\xc2\xf3\x18Z\b\x02\x10\x04\x1a\x11invitations:write\"\x11invitations:write*\b\n" +
	"\x02id\x10\x04\x18\x030\x01:\x18\n" +
	"\x14invitation.resent.v1\x10\x02@\x03H\x04P\x03X\x03`\x01\x82\xd3\xe4\x93\x02 :\x01*\"\x1b/v1/invitations/{id}:resend\x12\xd2\x01\n" +
	...
	"\x15invitation.revoked.v1\x10\x02@\x01H\x04P\x03X\x03`\x01\x82\xd3\xe4\x93\x02\x16*\x14/v1/invitations/{id}B\xb8\x01\n" +
