...
const file_saas_accounts_v1_teams_proto_rawDesc = "" +
	...
	"\amembers\x18\x01 \x03(\v2 .saas.accounts.v1.TeamMembershipR\amembers2\xeb\t\n" +
	"\vTeamService\x12\xbb\x01\n" +
	"\n" +
	"CreateTeam\x12#.saas.accounts.v1.CreateTeamRequest\x1a$.saas.accounts.v1.CreateTeamResponse\"b\xc2\xf3\x183\b\x02\x10\x04*\f\n" +
	"\x06org_id\x10\x02\x18\x010\x01:\x13\n" +
	"\x0fteam.created.v1\x10\x02@\x01H\x04P\x03X\x03`\x01\x82\xd3\xe4\x93\x02%:\x01*\" /v1/organizations/{org_id}/teams\x12\xa4\x01\n" +
	"\tListTeams\x12\".saas.accounts.v1.ListTeamsRequest\x1a#.saas.accounts.v1.ListTeamsResponse\"N\xc2\xf3\x18\"\b\x02\x10\x03*\f\n" +
	"\x06org_id\x10\x02\x18\x010\x01:\x02\x10\x01@\x01H\x03P\x03X\x03`\x01\x82\xd3\xe4\x93\x02\"\x12 /v1/organizations/{org_id}/teams\x12\xb0\x01\n" +
	"\tAddMember\x12&.saas.accounts.v1.AddTeamMemberRequest\x1a\x16.google.protobuf.Empty\"c\xc2\xf3\x189\b\x02\x10\x04*\r\n" +
	"\ateam_id\x10\x03\x18\x020\x01:\x18\n" +
	"\x14team.member_added.v1\x10\x02@\x01H\x04P\x03X\x03`\x01\x82\xd3\xe4\x93\x02 :\x01*\"\x1b/v1/teams/{team_id}/members\x12\xbf\x01\n" +
	"\fRemoveMember\x12).saas.accounts.v1.RemoveTeamMemberRequest\x1a\x16.google.protobuf.Empty\"l\xc2\xf3\x18;\b\x02\x10\x04*\r\n" +
	"\ateam_id\x10\x03\x18\x020\x01:\x1a\n" +
	"\x16team.member_removed.v1\x10\x02@\x01H\x04P\x03X\x03`\x01\x82\xd3\xe4\x93\x02'*%/v1/teams/{team_id}/members/{user_id}\x12\xae\x01\n" +
	...
	"\ateam_id\x10\x03\x18\x020\x01:\x02\x10\x01@\x01H\x03P\x03X\x03`\x01\x82\xd3\xe4\x93\x02\x1d\x12\x1b/v1/teams/{team_id}/members\x12\xaf\x01\n" +
	"\n" +
	"UpdateTeam\x12#.saas.accounts.v1.UpdateTeamRequest\x1a$.saas.accounts.v1.UpdateTeamResponse\"V\xc2\xf3\x184\b\x02\x10\x04*\r\n" +
	"\ateam_id\x10\x03\x18\x020\x01:\x13\n" +
	"\x0fteam.updated.v1\x10\x02@\x01H\x04P\x03X\x03`\x01\x82\xd3\xe4\x93\x02\x18:\x01*2\x13/v1/teams/{team_id}\x12\x9e\x01\n" +
	"\n" +
	"DeleteTeam\x12#.saas.accounts.v1.DeleteTeamRequest\x1a\x16.google.protobuf.Empty\"S\xc2\xf3\x184\b\x02\x10\x04*\r\n" +
	"\ateam_id\x10\x03\x18\x020\x01:\x13\n" +
	"\x0fteam.deleted.v1\x10\x02@\x01H\x04P\x03X\x03`\x01\x82\xd3\xe4\x93\x02\x15*\x13/v1/teams/{team_id}B\xb2\x01\n" +
	"\x14com.saas.accounts.v1B\n" +
	"TeamsProtoP\x01Z,accounts/pkg/gen/saas/accounts/v1;accountsv1\xa2\x02\x03SAX\xaa\x02\x10Saas.Accounts.V1\xca\x02\x10Saas\\Accounts\\V1\xe2\x02\x1cSaas\\Accounts\\V1\\GPBMetadata\xea\x02\x12Saas::Accounts::V1b\x06proto3"
