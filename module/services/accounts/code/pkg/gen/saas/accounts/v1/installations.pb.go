...
const file_saas_accounts_v1_installations_proto_rawDesc = "" +
	...
	"*INSTALLATION_HEALTH_STANDING_GRANT_MISSING\x10\x052\xe1\x06\n" +
	...
	"\x06org_id\x10\x02\x18\x010\x01:\x18\n" +
	"\x14installation.revoked\x10\x02@\x01H\x04P\x03X\x03`\x01\x82\xd3\xe4\x93\x022:\x01*\"-/v1/installations/{installation_id}:uninstall\x12\x85\x02\n" +
	"\x1dTransferInstallationOwnership\x126.saas.accounts.v1.TransferInstallationOwnershipRequest\x1a\x1e.saas.accounts.v1.Installation\"\x8b\x01\xc2\xf3\x18F\b\x02\x10\x04*\f\n" +
	"\x06org_id\x10\x02\x18\x010\x01:&\n" +
	"\"installation.ownership_transferred\x10\x02@\x01H\x04P\x03X\x03`\x01\x82\xd3\xe4\x93\x02;:\x01*\"6/v1/installations/{installation_id}:transfer-ownership\x12\xb9\x01\n" +
