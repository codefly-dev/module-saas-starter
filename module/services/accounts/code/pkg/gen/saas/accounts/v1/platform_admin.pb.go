...
const file_saas_accounts_v1_platform_admin_proto_rawDesc = "" +
	...
	"\x04name\x18\x01 \x01(\tR\x04name:\x02\x18\x012\x87\x1c\n" +
	...
	"\x1fsaas.platform.user_impersonated\x10\x02@\x01H\x05P\x03X\x04`\x03\x82\xd3\xe4\x93\x02-:\x01*\"(/v1/platform/users/{user_id}:impersonate\x12\xd8\x01\n" +
