...
- ❓ Multiple roles per person (additive)? ❓ Can a role be scoped to a branch at assignment (ties to `H`)?
...
- ❓ Do team grants and personal grants stack (union)?
...
- ❓ Enforce "can't grant above self"? ❓ Exception for Owner?
