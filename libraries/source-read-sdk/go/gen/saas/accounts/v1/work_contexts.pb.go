...
const file_saas_accounts_v1_work_contexts_proto_rawDesc = "" +
	...
	"%WORK_CONTEXT_REPLAY_POLICY_SINGLE_USE\x10\x022\xf1\f\n" +
	...
	"\x10ConsumeSingleUse\x124.saas.accounts.v1.ConsumeSingleUseWorkContextRequest\x1a\x16.google.protobuf.Empty\"\x18\xc2\xf3\x18\x14\b\x03\x10\x010\x01:\x02\x10\x01@\x01H\aP\x03X\x03`\x01\x12\xc8\x01\n" +
	"\tStartTask\x12-.saas.accounts.v1.StartTaskWorkContextRequest\x1a#.saas.accounts.v1.IssuedWorkContext\"g\xc2\xf3\x18B\b\x02\x10\x03*\f\n" +
	"\x06org_id\x10\x02\x18\x010\x01:\"\n" +
	"\x1esaas.work_context.task_started\x10\x02@\x01H\x05P\x03X\x04`\x01\x82\xd3\xe4\x93\x02\x1b:\x01*\"\x16/v1/work-contexts:task\x12\x86\x01\n" +
	"\x15StartInstallationTask\x12..saas.accounts.v1.StartInstallationTaskRequest\x1a#.saas.accounts.v1.IssuedWorkContext\"\x18\xc2\xf3\x18\x14\b\x03\x10\x010\x01:\x02\x10\x01@\x01H\aP\x03X\x04`\x01\x12\xe6\x01\n" +
	"\x10StartRootSession\x124.saas.accounts.v1.StartRootSessionWorkContextRequest\x1a#.saas.accounts.v1.IssuedWorkContext\"w\xc2\xf3\x18J\b\x02\x10\x03*\f\n" +
	"\x06org_id\x10\x02\x18\x010\x01:*\n" +
	"&saas.work_context.root_session_started\x10\x02@\x01H\x05P\x04X\x04`\x01\x82\xd3\xe4\x93\x02#:\x01*\"\x1e/v1/work-contexts:root-session\x12\xe9\x01\n" +
	"\x10ExchangeAudience\x124.saas.accounts.v1.ExchangeWorkContextAudienceRequest\x1a#.saas.accounts.v1.IssuedWorkContext\"z\xc2\xf3\x18H\b\x02\x10\x03*\f\n" +
	"\x06org_id\x10\x02\x18\x010\x01:(\n" +
	"$saas.work_context.audience_exchanged\x10\x02@\x01H\x05P\x04X\x04`\x01\x82\xd3\xe4\x93\x02(:\x01*\"#/v1/work-contexts:exchange-audience\x12\xea\x01\n" +
	"\x11StartChildSession\x125.saas.accounts.v1.StartChildSessionWorkContextRequest\x1a#.saas.accounts.v1.IssuedWorkContext\"y\xc2\xf3\x18K\b\x02\x10\x03*\f\n" +
	"\x06org_id\x10\x02\x18\x010\x01:+\n" +
	"'saas.work_context.child_session_started\x10\x02@\x01H\x05P\x04X\x04`\x01\x82\xd3\xe4\x93\x02$:\x01*\"\x1f/v1/work-contexts:child-session\x12\xc7\x01\n" +
	"\x10RenewWorkContext\x12).saas.accounts.v1.RenewWorkContextRequest\x1a#.saas.accounts.v1.IssuedWorkContext\"c\xc2\xf3\x18=\b\x02\x10\x03*\f\n" +
	"\x06org_id\x10\x02\x18\x010\x01:\x1d\n" +
	"\x19saas.work_context.renewed\x10\x02@\x01H\x05P\x04X\x04`\x01\x82\xd3\xe4\x93\x02\x1c:\x01*\"\x17/v1/work-contexts:renewB\xe0\x01\n" +
	"\x14com.saas.accounts.v1B\x11WorkContextsProtoP\x01ZSgithub.com/codefly-dev/cli/pkg/builder/clients/accounts/saas/accounts/v1;accountsv1\xa2\x02\x03SAX\xaa\x02\x10Saas.Accounts.V1\xca\x02\x10Saas\\Accounts\\V1\xe2\x02\x1cSaas\\Accounts\\V1\\GPBMetadata\xea\x02\x12Saas::Accounts::V1b\x06proto3"
