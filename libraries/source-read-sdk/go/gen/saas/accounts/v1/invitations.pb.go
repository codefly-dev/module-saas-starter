...
const file_saas_accounts_v1_invitations_proto_rawDesc = "" +
	...
	"%INVITATION_DELIVERY_STATUS_COMPLAINED\x10\x062\x9c\v\n" +
	"\x11InvitationService\x12\xea\x01\n" +
	"\x10CreateInvitation\x12).saas.accounts.v1.CreateInvitationRequest\x1a*.saas.accounts.v1.CreateInvitationResponse\"\x7f\xc2\xf3\x18a\b\x02\x10\x04\x1a\x11invitations:write\"\x11invitations:write*\f\n" +
	"\x06org_id\x10\x02\x18\x010\x01:\x1b\n" +
	"\x17saas.invitation.created\x10\x02@\x01H\x04P\x03X\x03`\x01\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/v1/invitations\x12\xa0\x01\n" +
	...
	"\x15InspectInvitationById\x12..saas.accounts.v1.InspectInvitationByIdRequest\x1a#.saas.accounts.v1.InvitationSummary\"=\xc2\xf3\x18\x14\b\x02\x10\x020\x01:\x02\x10\x01@\x01H\x03P\x03X\x03`\x01\x82\xd3\xe4\x93\x02\x1f:\x01*\"\x1a/v1/invitations:inspect-id\x12\xbe\x01\n" +
	"\x10AcceptInvitation\x12).saas.accounts.v1.AcceptInvitationRequest\x1a*.saas.accounts.v1.AcceptInvitationResponse\"S\xc2\xf3\x18.\b\x02\x10\x020\x01:\x1c\n" +
	"\x18saas.invitation.accepted\x10\x02@\x01H\x04P\x04X\x03`\x01\x82\xd3\xe4\x93\x02\x1b:\x01*\"\x16/v1/invitations:accept\x12\xc9\x01\n" +
	...
	"\x16saas.invitation.resent\x10\x02@\x03H\x04P\x03X\x03`\x01\x82\xd3\xe4\x93\x02 :\x01*\"\x1b/v1/invitations/{id}:resend\x12\xd4\x01\n" +
	"\x10RevokeInvitation\x12).saas.accounts.v1.RevokeInvitationRequest\x1a\x16.google.protobuf.Empty\"}\xc2\xf3\x18]\b\x02\x10\x04\x1a\x11invitations:write\"\x11invitations:write*\b\n" +
	"\x02id\x10\x04\x18\x030\x01:\x1b\n" +
	"\x17saas.invitation.revoked\x10\x02@\x01H\x04P\x03X\x03`\x01\x82\xd3\xe4\x93\x02\x16*\x14/v1/invitations/{id}B\xdf\x01\n" +
	"\x14com.saas.accounts.v1B\x10InvitationsProtoP\x01ZSgithub.com/codefly-dev/cli/pkg/builder/clients/accounts/saas/accounts/v1;accountsv1\xa2\x02\x03SAX\xaa\x02\x10Saas.Accounts.V1\xca\x02\x10Saas\\Accounts\\V1\xe2\x02\x1cSaas\\Accounts\\V1\\GPBMetadata\xea\x02\x12Saas::Accounts::V1b\x06proto3"
