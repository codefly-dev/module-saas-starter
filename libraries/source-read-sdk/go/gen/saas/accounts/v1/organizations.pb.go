...
import (
	...
	v1 "github.com/codefly-dev/module-saas-starter/libraries/source-read-sdk/go/gen/saas/composed/org_settings/v1"
...
const file_saas_accounts_v1_organizations_proto_rawDesc = "" +
	...
	"\amembers\x18\x01 \x03(\v2\x1f.saas.accounts.v1.OrgMembershipR\amembers2\x95\x0f\n" +
	...
	"\x11ListOrganizations\x12*.saas.accounts.v1.ListOrganizationsRequest\x1a+.saas.accounts.v1.ListOrganizationsResponse\"1\xc2\xf3\x18\x14\b\x02\x10\x020\x01:\x02\x10\x01@\x01H\x03P\x03X\x03`\x01\x82\xd3\xe4\x93\x02\x13\x12\x11/v1/organizations\x12\xb6\x01\n" +
	"\tAddMember\x12%.saas.accounts.v1.AddOrgMemberRequest\x1a\x16.google.protobuf.Empty\"j\xc2\xf3\x189\b\x02\x10\x04*\f\n" +
	"\x06org_id\x10\x02\x18\x010\x01:\x19\n" +
	"\x15saas.org.member_added\x10\x02@\x01H\x04P\x03X\x03`\x01\x82\xd3\xe4\x93\x02':\x01*\"\"/v1/organizations/{org_id}/members\x12\xc5\x01\n" +
	"\fRemoveMember\x12(.saas.accounts.v1.RemoveOrgMemberRequest\x1a\x16.google.protobuf.Empty\"s\xc2\xf3\x18;\b\x02\x10\x04*\f\n" +
	"\x06org_id\x10\x02\x18\x010\x01:\x1b\n" +
	"\x17saas.org.member_removed\x10\x02@\x01H\x04P\x03X\x03`\x01\x82\xd3\xe4\x93\x02.*,/v1/organizations/{org_id}/members/{user_id}\x12\xb2\x01\n" +
	...
	"!saas.org.generic_settings_updated\x10\x02@\x01H\x04P\x03X\x03`\x01\x82\xd3\xe4\x93\x020:\x01*\"+/v1/organizations/{org_id}/generic-settingsB\xe1\x01\n" +
	"\x14com.saas.accounts.v1B\x12OrganizationsProtoP\x01ZSgithub.com/codefly-dev/cli/pkg/builder/clients/accounts/saas/accounts/v1;accountsv1\xa2\x02\x03SAX\xaa\x02\x10Saas.Accounts.V1\xca\x02\x10Saas\\Accounts\\V1\xe2\x02\x1cSaas\\Accounts\\V1\\GPBMetadata\xea\x02\x12Saas::Accounts::V1b\x06proto3"
