...
const file_saas_accounts_v1_platform_admin_proto_rawDesc = "" +
	...
	"\x13saas.user.suspended\x10\x02@\x01H\x05P\x03X\x03`\x05\x82\xd3\xe4\x93\x02):\x01*\"$/v1/platform/users/{user_id}:suspend\x12\xb1\x01\n" +
	"\rUnsuspendUser\x12&.saas.accounts.v1.UnsuspendUserRequest\x1a\x16.google.protobuf.Empty\"`\xc2\xf3\x18+\b\x02\x10\x010\x01:\x19\n" +
	"\x15saas.user.unsuspended\x10\x02@\x01H\x05P\x03X\x03`\x05\x82\xd3\xe4\x93\x02+:\x01*\"&/v1/platform/users/{user_id}:unsuspend\x12\xd4\x01\n" +
	"\x0fImpersonateUser\x12(.saas.accounts.v1.ImpersonateUserRequest\x1a).saas.accounts.v1.ImpersonateUserResponse\"l\xc2\xf3\x185\b\x02\x10\x010\x04:#\n" +
	"\x1fsaas.platform.user_impersonated\x10\x02@\x01H\x05P\x03X\x04`\x03\x82\xd3\xe4\x93\x02-:\x01*\"(/v1/platform/users/{user_id}:impersonate\x12\xa6\x01\n" +
	...
	"\x06org_id\x10\x02\x18\x010\x01:\x02\x10\x01@\x01H\x03P\x03X\x03`\x01\x82\xd3\xe4\x93\x022\x120/v1/platform/organizations/{org_id}/entitlements\x12\xe2\x01\n" +
	"\x13OverrideEntitlement\x12,.saas.accounts.v1.OverrideEntitlementRequest\x1a-.saas.accounts.v1.OverrideEntitlementResponse\"n\xc2\xf3\x18/\b\x02\x10\x010\x01:\x1d\n" +
	"\x19saas.entitlement.override\x10\x02@\x01H\x05P\x03X\x03`\x02\x82\xd3\xe4\x93\x025:\x01*\"0/v1/platform/organizations/{org_id}/entitlements\x12\xab\x01\n" +
	"\x11GrantPlatformRole\x12*.saas.accounts.v1.GrantPlatformRoleRequest\x1a\x16.google.protobuf.Empty\"R\xc2\xf3\x180\b\x02\x10\x010\x04:\x1e\n" +
	"\x1asaas.platform.role_granted\x10\x02@\x01H\x05P\x03X\x03`\x05\x82\xd3\xe4\x93\x02\x18:\x01*\"\x13/v1/platform/admins\x12\xb4\x01\n" +
	"\x12RevokePlatformRole\x12+.saas.accounts.v1.RevokePlatformRoleRequest\x1a\x16.google.protobuf.Empty\"Y\xc2\xf3\x180\b\x02\x10\x010\x04:\x1e\n" +
	"\x1asaas.platform.role_revoked\x10\x02@\x01H\x05P\x03X\x03`\x05\x82\xd3\xe4\x93\x02\x1f*\x1d/v1/platform/admins/{user_id}\x12\xa4\x01\n" +
	...
	"\x10ListFeatureFlags\x12).saas.accounts.v1.ListFeatureFlagsRequest\x1a*.saas.accounts.v1.ListFeatureFlagsResponse\":\xc2\xf3\x18\x14\b\x02\x10\x010\x01:\x02\x10\x01@\x01H\x05P\x03X\x03`\x05\x82\xd3\xe4\x93\x02\x1c\x12\x1a/v1/platform/feature-flags\x12\xd0\x01\n" +
	"\x11UpsertFeatureFlag\x12*.saas.accounts.v1.UpsertFeatureFlagRequest\x1a+.saas.accounts.v1.UpsertFeatureFlagResponse\"b\xc2\xf3\x18/\b\x02\x10\x010\x01:\x1d\n" +
	"\x19saas.feature_flag.updated\x10\x02@\x01H\x05P\x03X\x03`\x05\x82\xd3\xe4\x93\x02&:\x01*\x1a!/v1/platform/feature-flags/{name}\x88\x02\x01\x12\x9f\x01\n" +
	...
	"\x16ListEventSubscriptions\x12-.saas.events.v1.ListEventSubscriptionsRequest\x1a..saas.events.v1.ListEventSubscriptionsResponse\"A\xc2\xf3\x18\x14\b\x02\x10\x010\x01:\x02\x10\x01@\x01H\x05P\x03X\x03`\x05\x82\xd3\xe4\x93\x02#\x12!/v1/platform/events/subscriptionsB\xe1\x01\n" +
	"\x14com.saas.accounts.v1B\x12PlatformAdminProtoP\x01ZSgithub.com/codefly-dev/cli/pkg/builder/clients/accounts/saas/accounts/v1;accountsv1\xa2\x02\x03SAX\xaa\x02\x10Saas.Accounts.V1\xca\x02\x10Saas\\Accounts\\V1\xe2\x02\x1cSaas\\Accounts\\V1\\GPBMetadata\xea\x02\x12Saas::Accounts::V1b\x06proto3"
