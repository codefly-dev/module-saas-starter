...
const file_saas_accounts_v1_teams_proto_rawDesc = "" +
	...
	"\amembers\x18\x01 \x03(\v2 .saas.accounts.v1.TeamMembershipR\amembers2\xf5\t\n" +
	...
	"\x06org_id\x10\x02\x18\x010\x01:\x02\x10\x01@\x01H\x03P\x03X\x03`\x01\x82\xd3\xe4\x93\x02\"\x12 /v1/organizations/{org_id}/teams\x12\xb2\x01\n" +
	"\tAddMember\x12&.saas.accounts.v1.AddTeamMemberRequest\x1a\x16.google.protobuf.Empty\"e\xc2\xf3\x18;\b\x02\x10\x04*\r\n" +
	"\ateam_id\x10\x03\x18\x020\x01:\x1a\n" +
	"\x16saas.team.member_added\x10\x02@\x01H\x04P\x03X\x03`\x01\x82\xd3\xe4\x93\x02 :\x01*\"\x1b/v1/teams/{team_id}/members\x12\xc1\x01\n" +
	"\fRemoveMember\x12).saas.accounts.v1.RemoveTeamMemberRequest\x1a\x16.google.protobuf.Empty\"n\xc2\xf3\x18=\b\x02\x10\x04*\r\n" +
	"\ateam_id\x10\x03\x18\x020\x01:\x1c\n" +
	"\x18saas.team.member_removed\x10\x02@\x01H\x04P\x03X\x03`\x01\x82\xd3\xe4\x93\x02'*%/v1/teams/{team_id}/members/{user_id}\x12\xae\x01\n" +
	...
	"\x11saas.team.updated\x10\x02@\x01H\x04P\x03X\x03`\x01\x82\xd3\xe4\x93\x02\x18:\x01*2\x13/v1/teams/{team_id}\x12\xa0\x01\n" +
	"\n" +
	"DeleteTeam\x12#.saas.accounts.v1.DeleteTeamRequest\x1a\x16.google.protobuf.Empty\"U\xc2\xf3\x186\b\x02\x10\x04*\r\n" +
	"\ateam_id\x10\x03\x18\x020\x01:\x15\n" +
	"\x11saas.team.deleted\x10\x02@\x01H\x04P\x03X\x03`\x01\x82\xd3\xe4\x93\x02\x15*\x13/v1/teams/{team_id}B\xd9\x01\n" +
	"\x14com.saas.accounts.v1B\n" +
	"TeamsProtoP\x01ZSgithub.com/codefly-dev/cli/pkg/builder/clients/accounts/saas/accounts/v1;accountsv1\xa2\x02\x03SAX\xaa\x02\x10Saas.Accounts.V1\xca\x02\x10Saas\\Accounts\\V1\xe2\x02\x1cSaas\\Accounts\\V1\\GPBMetadata\xea\x02\x12Saas::Accounts::V1b\x06proto3"
